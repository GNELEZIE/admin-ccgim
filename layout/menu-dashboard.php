...
?>
    ...
    <div class="link">
        <a href="<?=$domaine?>/compte/money"  class="<?= dash_active('money');?> <?= dash_active('orange');?> <?= dash_active('mtn');?><?= dash_active('moov');?>"> <span class="w80"><i class="fa fa-wallet font-13"></i> Money </span> </a>
    </div>
