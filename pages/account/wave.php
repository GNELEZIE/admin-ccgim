...
<script>
    ...
    $(document).ready(function() {
        ...
        table_moov = $('#table_moov').DataTable({
            "ajax": {
                "type": "post",
                "url": "<?=$domaine?>/controle/wave.liste",
                "data": {
                    token: "<?=$token?>"
                }
            },
        ...
        $('#formWave').submit(function(e){
            e.preventDefault();
            var value = document.getElementById('formWave');
            var form = new FormData(value);
            $.ajax({
                method: 'post',
                url: '<?=$domaine?>/controle/wave.save',
                data: form,
                contentType:false,
                cache:false,
                processData:false,
