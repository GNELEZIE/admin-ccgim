                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="superficie" id="superficie" class="form-control input-style input-height" placeholder="Superficie"  value="<?=html_entity_decode(stripslashes($lgtData['superficie']))?>"   style="padding-right: 33px;" step="any">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="chambre" id="chambre" class="form-control input-style input-height" placeholder="Chambres" value="<?=html_entity_decode(stripslashes($lgtData['chambres']))?>" style="padding-right: 33px;">
                                </div>
                            </div>
                        </div>
                        <div class="row">
